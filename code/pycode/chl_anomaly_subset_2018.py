...
print(f'2018 bloom anomaly time steps: {len(date_2018)}')
print(f'First: {str(date_2018[0])[:10]}, Last: {str(date_2018[-1])[:10]}')

# -- Save --
out_path = '/home/jamesash/koa_scratch/chl_anomaly_2018_bloom_20260328.nc'
...
anom_var.long_name = 'Chlorophyll anomaly, 2018 bloom period'

out.description = '2018 bloom anomaly subset (2018-06-19 to 2018-10-30)'
